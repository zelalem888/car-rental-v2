...
const AdminPrintReservation = async (r) => {
  try {
    // -----------------------------
    // FETCH DRIVER
    // -----------------------------
    ...
    const drawTable = (startY, rows, fontSize = 11, padding = 4) => {
      ...
      rows.forEach(([key, value]) => {
        page.drawText(key, { x: startX + 10, y: yText, size: fontSize, font: bold, color: rgb(0,0.5,0) });
    ...
    // FOOTER
    // -----------------------------
    page.drawText("Generated by SAMI Rental System Through Admins", {
      x: 40,
      y: nextY - 20,
      size: 9,
      font,
    ...
    a.download = "Reservation_Details_Admin.pdf";
    a.click();
...
export default AdminPrintReservation;
